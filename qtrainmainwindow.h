...
private:
    ...
    main_tab *m_tab;
    TalkbackView *talkwindow=Q_NULLPTR;
    m_searchLineEdit *searchEdit;
    QMAxWidget *flash_widget=Q_NULLPTR;//加载flahs控件
    QWebEngineView *web_PPt=Q_NULLPTR;//加载web ppt控件

     LoginForm *t=Q_NULLPTR;

    QStackedWidget *stacked_tree;
    QCompareView *compareview;
    QChoseCurriculumView *sheduleView=Q_NULLPTR;
    QTouchTrainView *touchTrain=Q_NULLPTR;
    QSetSystemView *systemView=Q_NULLPTR;
...
protected:
    QSerialPort*            m_pSerialPort=Q_NULLPTR;      //串口插件
